...
export default function OurArtificialIntelligence() {
    ...
    //                     <p>
    //                         Zyntellect developed an AI-powered chatbot to streamline URC’s dealer support operations. This chatbot tackles dealer inquiries on smart home automation devices, offering quick and accurate answers. It goes beyond text-based responses with voice interaction for a dynamic experience. The chatbot ensures prompt and accurate responses, providing personalized dealer support through the seamless integration of historical data, CRM information, and other data sources. This solution resulted in faster response times, improved user experience, and streamlined communication for URC.
    //                     </p>
    //                     <Link to="#">
