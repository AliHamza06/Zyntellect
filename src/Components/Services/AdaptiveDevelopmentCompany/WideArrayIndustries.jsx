...
export default function WideArrayIndustries() {
    const industries = [
        ...
        <>
            <div className="marginSet">
                <div className="mainHeroSection mt-0 pt-lg-4 pt-0">
                    <h2 className='mb-3'>Our Adaptive AI-based Development Services Cater to a Wide Array of Industries</h2>
                </div>
            </div>
            <div className="wide-array-industries container marginSet">
