...
var CardBody = React13.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
function useForceUpdate() {
  const [, dispatch] = (0, import_react22.useReducer)((state) => !state, false);
  return dispatch;
}
...
function useDropdownMenu(options = {}) {
  const context4 = (0, import_react26.useContext)(DropdownContext_default);
...
function Dropdown({
  ...
  const context4 = (0, import_react31.useMemo)(() => ({
    toggle,
    placement,
    show,
    menuElement,
...
var TabContext = React53.createContext(null);
...
var NavItem = React54.forwardRef((_ref, ref) => {
  let {
    as: Component2 = Button_default,
    active,
    eventKey
...
var Nav = React55.forwardRef((_ref, ref) => {
  let {
    // Need to define the default "as" during prop destructuring to be compatible with styled-components github.com/react-bootstrap/react-bootstrap/issues/3595
    as: Component2 = "div",
    onSelect,
...
var ListGroupItem = React56.forwardRef(({
  bsPrefix,
  active,
  disabled,
  eventKey,
...
var ListGroup = React57.forwardRef((props, ref) => {
  const {
    className,
...
function getReactVersion() {
  const parts = React58.version.split(".");
  return {
    major: +parts[0],
    minor: +parts[1],
    patch: +parts[2]
...
var RTGTransition = React59.forwardRef((_ref, ref) => {
  ...
  return (0, import_jsx_runtime56.jsx)(Component2, Object.assign({
    ref
  }, transitionProps));
});
...
function renderTransition(component, runTransition, props) {
  if (component) {
    return (0, import_jsx_runtime57.jsx)(RTGTransition_default, Object.assign({}, props, {
      component
    }));
  }
  if (runTransition) {
    return (0, import_jsx_runtime57.jsx)(ImperativeTransition, Object.assign({}, props, {
      transition: runTransition
    }));
  }
  return (0, import_jsx_runtime57.jsx)(NoopTransition_default, Object.assign({}, props));
}
...
var Modal = (0, import_react43.forwardRef)((_ref, ref) => {
  let {
    ...
    restoreFocusOptions,
    renderDialog,
    renderBackdrop = (props) => (0, import_jsx_runtime58.jsx)("div", Object.assign({}, props)),
  ...
  let dialog = renderDialog ? renderDialog(dialogProps) : (0, import_jsx_runtime58.jsx)("div", Object.assign({}, dialogProps, {
  ...
  return (0, import_jsx_runtime58.jsx)(import_jsx_runtime59.Fragment, {
    children: import_react_dom.default.createPortal((0, import_jsx_runtime60.jsxs)(import_jsx_runtime59.Fragment, {
...
var Modal2 = React69.forwardRef(({
  ...
  const renderBackdrop = (0, import_react45.useCallback)((backdropProps) => (0, import_jsx_runtime68.jsx)("div", {
    ...backdropProps,
...
var NavbarCollapse = React74.forwardRef(({
  ...
  const context4 = (0, import_react47.useContext)(NavbarContext_default);
...
var Offcanvas = React80.forwardRef(({
  ...
  const renderBackdrop = (0, import_react51.useCallback)((backdropProps) => (0, import_jsx_runtime79.jsx)("div", {
    ...backdropProps,
...
var NavbarOffcanvas = React81.forwardRef((props, ref) => {
  const context4 = (0, import_react52.useContext)(NavbarContext_default);
...
function useOverlayOffset(customOffset) {
  ...
  const offset = (0, import_react56.useMemo)(() => ({
    name: "offset",
    options: {
      offset: () => {
        if (customOffset) {
...
var OverlayTrigger = ({
  ...
  return (0, import_jsx_runtime96.jsxs)(import_jsx_runtime95.Fragment, {
    children: [typeof children === "function" ? children(triggerProps) : (0, import_react58.cloneElement)(children, triggerProps), (0, import_jsx_runtime94.jsx)(Overlay_default2, {
      ...props,
      show,
      onHide: handleHide,
      flip,
...
function useTabPanel(_ref) {
  ...
  const context4 = (0, import_react60.useContext)(TabContext_default);
...
var ToastFade = React110.forwardRef((props, ref) => (0, import_jsx_runtime117.jsx)(Fade_default, {
  ...props,
  ref,
...
var ToastHeader = React112.forwardRef(({
  ...
  const context4 = (0, import_react62.useContext)(ToastContext_default);
  const handleClick = useEventCallback((e) => {
